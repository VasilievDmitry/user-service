...
type UserProfile struct {
	...
	CentrifugoToken bool `protobuf:"varint,6,opt,name=centrifugo_token,json=centrifugoToken,proto3" json:"centrifugo_token,omitempty"`
}
...
func (x *UserProfile) GetCentrifugoToken() bool {
	if x != nil {
...
var file_user_service_entity_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x0f, 0x63, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x66, 0x75, 0x67, 0x6f, 0x54,
